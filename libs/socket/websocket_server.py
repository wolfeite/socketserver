...
class API():
    ...
    def message_received(self, client, server, message):
        pass
    def handle_error(self, client, server, error):
        pass
    ...
    def set_fn_error(self, fn):
        self.handle_error = fn
...
class WebsocketServer(ThreadingMixIn, TCPServer, API):
    ...
    def _handle_error_(self, handler, error):
        self.handle_error(self.handler_to_client(handler), self, error)
...
class WebSocketHandler(StreamRequestHandler):
    ...
    def handle(self):
        try:
            ...
            self.server._handle_error_(self, e)
